...
[![GHCR](https://img.shields.io/badge/ghcr.io-opencomputinggarage%2Flogstash--with--opensearch--plugin-000000?style=flat-square&logo=github&logoColor=white)](https://github.com/opencomputinggarage/containers/pkgs/container/logstash-with-opensearch-plugin)
...
spec:
  ...
  podTemplate:
    spec:
      containers:
        - name: logstash
          image: ghcr.io/opencomputinggarage/logstash-with-opensearch-plugin:8.19.0
  pipelines:
    - pipeline.id: main
      config.string: |
...
Image: `ghcr.io/opencomputinggarage/logstash-with-opensearch-plugin:<TAG>`
